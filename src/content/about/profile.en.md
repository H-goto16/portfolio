...
I work full-time at **Arent Inc.** while also taking on freelance projects for several startups to broaden my experience and technical perspective.
...
Currently, I’m primarily engaged in **B2B and B2C**, while also sharing knowledge and insights through platforms like **Qiita** and **Zenn**.

## Work & Projects

+ **Univearth Inc. (Part-time => Freelance => Full-time)**
  - Frontend: Developing B2B SaaS products using Next.js (v12–15), React, TypeScript, TailwindCSS, and Ant Design.
    Responsible for PR reviews and feature implementation. Project Leader.
  - Mobile: Building and deploying React Native apps for iOS, Android, and Web from scratch by myself.
...
More Information : [YOUTRUST](https://youtrust.jp/users/haruki-goto)
: [Wantedly](https://www.wantedly.com/id/haruki_goto)
